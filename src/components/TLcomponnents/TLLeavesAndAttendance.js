...
// import "../../styles/HRLeavesAndAttendance.css";
...
import UserLogin from "../CheckIn&moodmap/UserMoodAllDay";


function TLLeavesAndAttendance({ employees }) {
  ...
  return (
    ...
    >
      <div className="attendance-upper-container">
        ...
        <UserLogin employees={employees} />
      </div>
    </div>
  );
}

export default TLLeavesAndAttendance;
